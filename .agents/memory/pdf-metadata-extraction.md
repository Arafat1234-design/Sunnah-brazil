...
When PDF metadata is missing, first-page text may list the author as an unlabelled name, but it often also lists translators, editors, reviewers, and adaptation credits. Author inference should recognize explicit author labels and conservative person-name patterns while excluding those contributor roles.
